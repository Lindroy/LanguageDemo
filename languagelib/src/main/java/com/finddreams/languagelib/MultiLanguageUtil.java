...
public class MultiLanguageUtil {
    ...
    public void setConfiguration() {
        ...
        Log.e(TAG, "国家=" + targetLocale.getCountry() + ",语种=" + targetLocale.getLanguage());
...
//        mContext.createConfigurationContext(configuration);
    ...
    private Locale getLanguageLocale() {
        ...
        if (languageType == LanguageType.LANGUAGE_FOLLOW_SYSTEM) {
            ...
            } else if (TextUtils.equals(sysType.getLanguage(), Locale.KOREAN.getLanguage())) {
...
//            return LocaleList.getDefault().get(0);
    ...
    public int getLanguageType() {
        ...
        Log.d(TAG, "getLanguageType=" + languageType);
        return languageType;
    }
